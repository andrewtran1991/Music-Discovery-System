			...
			columnDefs:[
				{
					...
					render:function(data,type,row,meta){
						return "<iframe src='https://open.spotify.com/embed/track/" + data + "'width='300' height='80' frameborder='0' allowtransparency='true' allow='encrypted-media'></iframe>";
					}
				}
			]
        });
